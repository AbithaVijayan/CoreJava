...
public class TrainerDemo {
	public static void main(String[] args) {
		...
		trainers.add(new Trainer(1000,"Abitha","Java",12345.67));
		trainers.add(new Trainer(2000,"Saritha","Java",23456.78));
		trainers.add(new Trainer(3000,"Kavitha","Python",34567.89));
		trainers.add(new Trainer(4000,"Akshita","Java",43215.6));
		trainers.add(new Trainer(5000,"Aishu","HTML",38000));
